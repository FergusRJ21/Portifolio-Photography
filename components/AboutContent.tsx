// Documentação: Componente de Conteúdo Animado da Página Sobre (Corrigido para Produção)
// src/components/AboutContent.tsx

"use client";

// Importamos 'motion' e o tipo 'Variants' para satisfazer a verificação estrita do TypeScript
import { motion, Variants } from "framer-motion";
import Image from "next/image";

export default function AboutContent() {
    // Tipamos explicitamente como 'Variants' para evitar conflitos de tipos no build do Netlify
    ...
    return (
        ...
        >
            ...
            <motion.section
                variants={itemVariants} // Correção: Mudado de 'variantes' para 'variants'
